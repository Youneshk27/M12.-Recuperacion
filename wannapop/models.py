...
class User(db.Model, BaseMixin, SerializableMixin, UserMixin):
    ...
    one_time_token = db.Column(db.String(150), nullable=True)
    ...
    def generate_token(self):
        self.one_time_token = secrets.token_urlsafe(16)
        self.token_expiration = datetime.utcnow() + timedelta(seconds=int(os.getenv('ONE_TIME_TOKEN_EXPIRATION')))
        db.session.commit()
